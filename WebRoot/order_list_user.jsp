					...
					<div class=" cart-items">
						...
						<div class="in-check">
							...
							<ul class="cart-header">
								...
								<li><span><input type="hidden" name="price" value="${item.price}">${item.price}</span></li>
								<li><span><input type="text" name="buyTotal" value="${total}" disabled></span></li>
								<li><span>${buyTime}</span></li>
									<c:if test="${status==0}"><li style="font-size:bold;color:red;">未发货</li></c:if>
									<c:if test="${status==1}"><li style="font:bold green">已发货</li></c:if>
