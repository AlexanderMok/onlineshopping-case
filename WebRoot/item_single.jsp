...
<link rel="stylesheet" href="css/bootstrap/etalage.css">
...
<div class=" header-product">
	<div class="header-top">
		<div class="container">
			...
			<div class="container">			
				<div class="logo">
					<h1><a href="index.html">Amberegul商城</a></h1>
				</div>
				<div class="top-nav">
				<!-- start header menu -->
...
<!---->
<div class="container">
	<h6 class="dress"><a href="index.action">首页</a> <i> </i> ${item.itemName} </h6>
</div>
<div class="back">
	<h2></h2>
</div>
...
<div class=" per1">
				...
				<div class="col-md-5 single-top">	
					...
					<form action="addcart.action?itemId=${item.id}&itemName=${item.itemName}" method="post">	
					<div class="col-md-7 single-top-in simpleCart_shelfItem">
						...
						<h4>${item.itemName}</h4>
							...
							<ul class="tag-men">
								...
								<li><span>数量</span>
								<span class="women1">:<input type="text" name="buyTotal"></span></li>
							</ul>
								<%-- <a href="addcart.action?itemId=${item.id}&itemName=${item.itemName}" class="add-cart item_add">加入购物车</a> --%>
